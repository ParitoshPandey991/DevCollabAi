...
const TicketDetails = () => {
  ...
  const fetchTicketDetails = async () => {
    try {
        const response = await apiService.getTicketById(id, token);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 animate-fade-in-up">
          <button 
            onClick={() => navigate('/dashboard')}
            className="flex items-center space-x-2 cursor-pointer text-indigo-600 hover:text-indigo-700 transition-colors duration-200 mb-4 group"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Status Timeline */}
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 animate-fade-in-up delay-500">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Status Timeline</h3>
              
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className={`w-3 h-3 rounded-full ${ticket.status === 'TODO' ? 'bg-yellow-500' : 'bg-green-500'}`}></div>
                ...
                {(ticket.status === 'IN_PROGRESS'  ) && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500">Processed by AI</p>
                    </div>
                  </div>
                )}
                ...
                {(ticket.status === 'ASSIGNED' ) && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">Assigned to Moderator</p>
                ...
                {ticket.status === 'COMPLETED' && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500">Issue has been resolved</p>
                    </div>
                  </div>
                )}
              </div>
